...
:: Android packaging
set AND_CERT_NAME="Tank Game"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TankGame.p12
...
set IOS_PROVISION=cert\TankGame.mobileprovision
...
set APP_ID=air.TankGame

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TankGame
